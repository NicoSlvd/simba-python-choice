...
Beta_work_sched_fully_fixed = Beta('Beta_work_sched_fully_fixed', 0, None, None, 1)
Beta_work_sched_fixed_daily_blocks = Beta('Beta_work_sched_fixed_daily_blocks', 0, None, None, 0) # normalised to 0
...
Beta_compulsory_education = Beta('Beta_compulsory_education', 0, None, None, 0) # normalised to 0
Beta_secondary_education = Beta('Beta_secondary_education', 0, None, None, 0)
Beta_tertiary_education = Beta('Beta_tertiary_education', 0, None, None, 1)
...
V = (
    ...
    #Beta_job_x_CH1903 * job_x_CH1903/1000000 +
    #Beta_job_y_CH1903 * job_y_CH1903/1000000 +
