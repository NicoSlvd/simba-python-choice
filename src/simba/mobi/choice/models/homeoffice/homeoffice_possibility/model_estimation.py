...
av = {0: 1, 1: 1}  # Assuming both alternatives are always available

current_dir = os.getcwd()

os.chdir('output/data/')
# Define the model
logit_model = models.loglogit(V, av, can_work_from_home)

# Create the biogeme object
biogeme = bio.BIOGEME(database, logit_model)
biogeme.modelName = "wfh_model"
