...
def estimate_linearised_model_telecommuting(
    df_zp: pd.DataFrame,
...
def run_estimation(
    ...
    U = (
        ...
        + models.piecewiseFormula(
            accsib_home_not_NA_21, [None, 0.2, 0.45, 0.6, 1.4, 9.1, 15, 95, 16.05, None]
        )  # linearised from rumboost
    ...
    if intensity_cutoff:
        model_name = f"wfh_intensity{intensity_cutoff}_model_linearised_sbb_seed0"
        ...
        model_name = f"wfh_possibility_model_linearised_sbb_seed0"
    ...
    file_name = (
        f"parameters_dcm_linearised_wfh_{str_model}_"
